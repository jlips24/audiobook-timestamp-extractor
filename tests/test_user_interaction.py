...
from src.user_interaction import verify_chapters, get_book_metadata
...
class TestUserInteraction(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['', '', '12345']) # Defaults for author/title
    @patch('builtins.print')
    def test_get_book_metadata_defaults(self, mock_print, mock_input):
        mock_parser = MagicMock()
        mock_parser.get_metadata.return_value = {'author': 'Def Auth', 'title': 'Def Title'}
